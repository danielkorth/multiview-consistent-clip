...
class ViewInvariantEmbeddingModule(LightningModule):
    ...
    def training_step(
        ...
        self.log("train/sim_score", sim_score, on_step=True, on_epoch=True, prog_bar=True)
        self.log("train/dissim_score", dissim_score, on_step=True, on_epoch=True, prog_bar=True)
        return loss
